...
<?php
 if(isset($_POST['timkiem'])){
  $s=$_POST['search'];
  $sql = "SELECT * FROM hang_hoa WHERE ten_hh like N'%$s%'";
 }
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <nav class="nav-main">
        <ul>
            ...
            <li><a href="./smartwach.php">Smartwach</a></li>
            <li><a href="./loa.php">Loa</a></li>
            <li><a href="./giohang.php">Giỏ hàng của bạn</a></li>
            <li><a href="../user/login.php">Đăng nhập</a></li>
            <li><a href="../admin/khachhang/addkh.php">Đăng ký</a></li>
            <li><a href="../user/loginadmin.php">Admin</a></li>
            
         </ul>  
         <form action="timkiem.php" method="GET" class="form">
                <input type="seach" name="search" required placeholder = "tìm kiếm đi" class="fomr1">
                <input type="submit" value="Tìm kiếm" name="timkiem" class="hi3">
    ...
    <?php
        ...
        $sql = "SELECT * FROM hang_hoa WHERE dac_biet=1 ORDER BY ma_hh ASC LIMIT $nhap,$sobanghi";
        $stmt = $conn->prepare($sql);
        $stmt->execute();
        $product = $stmt->fetchAll(PDO::FETCH_ASSOC);
        foreach($product as $sp):?>
         <div class="sanpham" style="border: 1px solid blue; width: 300px;float: left; text-align: center; margin-left: 20px; height: 400px; margin-top: 50px;">
        <h2 class="name" style="color: red;"><?=$sp['ten_hh']?></h2>
        <h3 class="gia" style="color: rgb(15, 208, 28);"><?=number_format($sp['don_gia'],0,",",".")?> VND</h4>
    ...
    <footer class="footer">
     ...
     <h3 class="chinhsach" style="margin-left: 100px; color: blue; font-size: 20px; margin-top: 20px;">Chính sách giao hàng</h3>
       ...
       <div class="cong" style="margin-left: 750px; margin-top: 90px;">
         <img src="../admin/images/tải xuống.png" alt="" width="250px" height="100px">
       </div>
       <div>
       <h4 class="diachi" style="margin-left: 1300px; margin-top: -250px;">Địa chỉ</h4>
