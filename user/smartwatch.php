  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <nav class="nav-main">
        <ul>
            ...
            <li><a href="./smartwatch.php">Smartwach</a></li>
    ...
    <div class="conten">
      ...
      <?php
        ...
        $sql = "SELECT * FROM hang_hoa where ma_loai=5 LIMIT $nhap,$sobanghi";
      ...
      <div class="hi">
        ...
        for($i = 1; $i<=$pagesum;$i++){
        ?>
        <a style="border: 1px solid red;" href="smartwatch.php?page=<?=$i?>"><?=$i?></a>
