  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <div class="conten">
      <div class="conten-right" style="width: 200px;">
              ...
              <a href="./hanghoa/showsp.php">Hàng hóa</a>
              </div>
              <div class="hang" style="list-style: none; margin-left: 40px; color: white; margin-top:30px; width: 150px;">
              <a href="./loaihang/showlh.php">Loại hàng</a>
              </div>
              <div class="hang" style="list-style: none; margin-left: 40px; color: white; margin-top:30px; width: 150px;">
              <a href="./khachhang/showkh.php">Khách hàng</a>
              </div>
              <div class="hang" style="list-style: none; margin-left: 40px; color: white; margin-top:30px; width: 150px;">
              <a href="./binhluan/showbl.php">Bình luận</a>
              </div>
              <div class="hang" style="list-style: none; margin-left: 40px; color: white; margin-top:30px; width: 150px;">
              <a href="./thongke/bieudo.php">Thống kê</a>
              </div>

      </div>
      <div class="conten-main" style="width: 1500px;">
      <h1 style="color: red; margin-top: 100px; margin-left: 500px;">Chào anh thành đẹp trai hehe</h1>
      <h3 style="color: red; margin-left: 600px;">Chọn chức năng bên trái nha</h3>
      <h6 style="color: red; margin-left: 1200px; margin-top: 300px; font-size: 10px;">Sai rồi bên trai kia cơ mà</h6>
    ...
    <footer class="footer">
     ...
     <h3 class="chinhsach" style="margin-left: 100px; color: blue; font-size: 20px; margin-top: 20px;">Chính sách giao hàng</h3>
       ...
       <div class="cong" style="margin-left: 750px; margin-top: -45px;">
         <img src="./images/tải xuống.png" alt="" width="250px" height="100px">
       </div>
       <div>
