...
<head>
    ...
    <title>Show khách hàng</title>
    <link rel="stylesheet" href="../filecssadmin/showkh.css">
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <nav class="nav-main">
        <ul>
            ...
            <li><a href="">Ipad</a></li>
            <li><a href="">Loa</a></li>
            <li><a href="../showadmin.php">Admin</a></li>
    ...
    <div class="conten">
      ...
      <div class="hang" style="list-style: none; margin-left: 40px; color: white; margin-top:30px;">
    ...
    <footer class="footer">
     ...
     <h3 class="chinhsach" style="margin-left: 100px; color: blue; font-size: 20px; margin-top: 20px;">Chính sách giao hàng</h3>
       ...
       <div class="cong" style="margin-left: 750px; margin-top: -45px;">
         <img src="../images/congthuong.png" alt="" width="250px" height="100px">
       </div>
       <div>
